 ...
 *
 */
function educativ_creativ_custom_header_setup() {
...
add_action( 'after_setup_theme', 'educativ_creativ_custom_header_setup' );

if( !function_exists( 'educativ_creativ_render_banner_section' ) ) :
	/**
	 * Hook to display banner section
	 *
	 * @since Kids Education 0.1
	 */
	function educativ_creativ_render_banner_section() {
...
add_action( 'educativ_creativ_header_action', 'educativ_creativ_render_banner_section', 20 );
add_action( 'educativ_creativ_header_action', 'kids_education_navigation', 10 );